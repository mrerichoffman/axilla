...
def main(config):
    ...
    if "error" in hourlyCocktail:
        ...
        imgSrc = http.get("https://firebasestorage.googleapis.com/v0/b/daddy-king.appspot.com/o/profile-images%2FeehYlvIY897l5PJWrRZS%2FOfO1tE9JD9nAqPzznKYP%2Folivia-2-small.jpg?alt=media&token=b75b0262-05d4-49fd-b7e1-f3a88b81e03d").body()
